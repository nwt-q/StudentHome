...
void AdminViews::StudentInfoDisplay()
{
    setbkmode(TRANSPARENT);
    IMAGE img;
    loadimage(&img, "../resources/Photo/20.png", 1280, 720);/*变量地址，图片地址    相对地址“./”本目录下的文件进行访问   图片展示可以是png也可以是jpg*/
    putimage(0, 0, &img);/*展示图片*/
    setbkmode(TRANSPARENT);
    //StudentshowButton(1, 15, 100, 50, "返回菜单", 20, fillColor, textColor);
    Button = new EasyButton(1145, 15, 100, 50, "下一页", 20, fillColor, textColor);
    ///StudentshowButton(1145, 15, 100, 50, "下一页", 20, fillColor, textColor);  //Header
    IMAGE right;
    IMAGE Right;
    loadimage(&Right, "../resources/Photo/right1.jpg", 120, 100);/*变量地址，图片地址    相对地址“./”本目录下的文件进行访问   图片展示可以是png也可以是jpg*/
    putimage(1, 15, &Right,SRCPAINT);/*展示图片*/
    loadimage(&right, "../resources/Photo/right.jpg", 120, 100);/*变量地址，图片地址    相对地址“./”本目录下的文件进行访问   图片展示可以是png也可以是jpg*/
...
/*
    ...
    返回值：bool
*/
 int AdminViews::AdminOn_btnOk_Click()
{
...
//void AdminViews::AdminOn_Delete_Click()
//{
...
/*
    ...
    返回值：void
*/
[[maybe_unused]] void AdminViews::AdminPage() {
    // 简单绘制界面
    //setbkcolor(0xeeeeee);
    ...
    settextcolor(BLACK);
    BtnOK = new EasyButton(620, 470, 700, 495, "Login", AdminOn_btnOk_Click());	// 创建按钮控件
    BtnOUT = new EasyButton(420, 470, 500, 495, "OUT", AdminOn_btnOk_Click());	// 创建按钮控件
...
/*
    ...
    返回值：void
*/
int AdminViews::AdminView() {
    using namespace gx;
    cleardevice();
    IMAGE img;
    loadimage(&img, "../resources/Photo/IV.png", 1280, 720);/*变量地址，图片地址    相对地址“./”本目录下的文件进行访问   图片展示可以是png也可以是jpg*/
    putimage(0, 0, &img);/*展示图片*/

    Button = new EasyButton(BUTTONX, 100, BUTTONW, BUTTONH, "学生信息", 48, fillColor, textColor);
    //StudentshowButton(BUTTONX, 100, BUTTONW, BUTTONH, "学生信息", 48, fillColor, textColor);
    Button = new EasyButton(BUTTONX, 250, BUTTONW, BUTTONH, "信息删除", 48, fillColor, textColor);

    Button = new EasyButton(BUTTONX, 400, BUTTONW, BUTTONH, "关闭音乐", 48, fillColor, textColor);

    Button = new EasyButton(BUTTONX, 550, BUTTONW, BUTTONH, "退出登入", 48, fillColor, textColor);
...
/*
    ...
    返回值：void
*/
void AdminViews::CorrectiveView() {
    using namespace gx;
    cleardevice();
    setbkcolor(0xeeeeee);
    IMAGE img;
    ...
    settextcolor(BLACK);
    settextstyle(15, 0, "");//设置字号、字体
    //BtnOK = new EasyButton(620, 470, 700, 495, "Delete", AdminOn_Delete_Click());	// 创建按钮控件
    BtnOUT = new EasyButton(420, 470, 500, 495, "OUT", AdminView());	// 创建按钮控件
    settextstyle(30, 0, "");//设置字号、字体
}

void AdminViews::AdminMenu() {
