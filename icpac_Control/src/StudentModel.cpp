...
*/
void OpenMusic() {
//	mciSendString(("open su.mp3 alias ../Music/backgroundMusic.mp3"), NULL, 0, NULL);//播放音乐
//	mciSendString(("play ../Music/backgroundMusic.mp3 repeat"), NULL, 0, NULL);//循环播放
}
...
*/
void CloseMusic() {
//	mciSendString(("close  ../Music/backgroundMusic.mp3"), NULL, 0, NULL);//关闭音乐
}
...
bool StudentModel::resign(std::string name, std::string power) {
    return false;
}

bool StudentModel::sign(std::string name, std::string power) {
    return false;
}

bool StudentModel::Login(std::string name, std::string power) {
    return false;
}
